<?php
	...
	class Dt_searchschedule extends CI_Model 
	{

		var $table = 'schedule';
		var $column_order = array(null,'sch_title','sch_date','sch_time','usg_name');
		var $column_search = array('sch_title','sch_date','sch_time','usg_name');
